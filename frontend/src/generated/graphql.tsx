...
export type CreateProjectMutation = { __typename?: 'Mutation' } & {
  createProject: { __typename?: 'ProjectDto' } & Pick<
    ProjectDto,
...
export type DeleteProjectMutation = { __typename?: 'Mutation' } & {
  deleteProject: { __typename?: 'ProjectDto' } & Pick<
    ProjectDto,
    '_id' | 'name'
  >;
};
...
export type MeQuery = { __typename?: 'Query' } & {
  me: Maybe<
    { __typename?: 'UserAuthDto' } & {
      user: Maybe<{ __typename?: 'UserDto' } & Pick<UserDto, '_id' | 'email'>>;
      permissions: Maybe<
        Array<
          { __typename?: 'PermissionStateDto' } & Pick<
            PermissionStateDto,
            'slug' | 'permitted'
          >
        >
...
export type ProjectQuery = { __typename?: 'Query' } & {
  project: { __typename?: 'ProjectDto' } & Pick<
    ProjectDto,
    '_id' | 'name' | 'description'
  >;
};
...
export type SignInMutation = { __typename?: 'Mutation' } & {
  signin: { __typename?: 'UserAuthDto' } & Pick<
    UserAuthDto,
  ...
  > & {
      ...
      >;
      userTemp: Maybe<
        { __typename?: 'UserTempDto' } & Pick<UserTempDto, 'name' | 'email'>
      >;
    };
};
...
export type SignUpMutation = { __typename?: 'Mutation' } & {
  signup: { __typename?: 'UserAuthDto' } & Pick<UserAuthDto, 'accessToken'> & {
      user: Maybe<{ __typename?: 'UserDto' } & Pick<UserDto, '_id' | 'email'>>;
      permissions: Maybe<
        Array<
          { __typename?: 'PermissionStateDto' } & Pick<
...
export type UpdateProjectMutation = { __typename?: 'Mutation' } & {
  updateProject: { __typename?: 'ProjectDto' } & Pick<
    ProjectDto,
    '_id' | 'name' | 'description'
  > & { user: Maybe<{ __typename?: 'User' } & Pick<User, '_id'>> };
};
